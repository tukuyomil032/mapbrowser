...
- 2026-03-23: Phase D3 を実装。FrameProcessorの閾値を環境変数で調整可能にし、実行時メトリクスの周期ログを追加。
- 2026-03-23: D3追補。PageController側のFPS制御閾値/計測ウィンドウも環境変数で調整可能に拡張。
- 2026-03-23: D3追補2。適応FPSにヒステリシス（連続判定）を導入し、短期スパイクでの揺れを抑制。
